package hex_action_manifest.utils
...
abstract class HexActionManifestModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexActionManifestModDependenciesExtension>("hexactionmanifestModDependencies")
